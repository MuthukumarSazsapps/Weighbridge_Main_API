...
declare function Select<OptionType extends SelectOption>({ label, labelWeight, error, options, disabled, helperText, prefix, placeholder, inPortal, modal, displayValue, getOptionDisplayValue, getOptionValue, value, onClear, clearable, placement, gap, size, rounded, shadow, variant, suffix, searchable, searchType, searchProps, searchPrefix, searchSuffix, searchDisabled, searchReadOnly, searchPlaceHolder, className, searchByKey, labelClassName, selectClassName, optionClassName, suffixClassName, prefixClassName, errorClassName, helperClassName, searchClassName, dropdownClassName, searchPrefixClassName, searchSuffixClassName, searchContainerClassName, ...props }: SelectProps<OptionType>): react_jsx_runtime.JSX.Element;
...
type MultiSelectProps<MultiSelectOption> = ExtractProps<typeof Listbox> & {
     ...
     * @returns React node to display for the selected item.
     */
    displayValue?: (option: MultiSelectOption, handleClearItem?: (item: string) => void) => React__default.ReactNode;
    /**
